    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 pt-5 pb-3">
          ...
          <div>
            <h3 className="text-base font-semibold text-foreground">操作确认</h3>
            <p className="text-xs text-muted-foreground">此操作不可逆</p>
          </div>
        </div>

        {/* Content */}
        <div className="px-5 pb-4">
          <p className="text-sm text-muted-foreground mb-3">即将执行不可逆操作：</p>
          <div className="bg-muted rounded-lg p-3 mb-3">
            ...
            <div className="text-xs text-muted-foreground mt-2 mb-1">参数</div>
