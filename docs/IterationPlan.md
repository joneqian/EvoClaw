...
| 图片分析工具（vision 模型） | 🔲 待开发 | 03-18 |
| PDF 阅读工具（pdf-parse） | 🔲 待开发 | 03-18 |
| apply_patch 工具（多文件统一 diff） | 🔲 待开发 | 03-18 |
| 子 Agent 生命周期（spawn/list/steer/kill + 完成通知） | 🔲 待开发 | 03-18 |
...
| 任务 | 时间 | 验收标准 |
|------|------|---------|
| 图片分析工具 | 1.5h | base64 图片发送 vision 模型，返回描述 |
| PDF 阅读工具 | 1h | pdf-parse 提取文本，支持分页 |
| apply_patch 工具 | 2h | 多文件统一 diff 格式，正确应用修改 |
| 子 Agent 生命周期 | 2h | spawn/完成通知/深度限制 |
...
| PDF 解析 | pdf-parse | 纯 JS，无原生依赖，易 bundle |
